...
var MV_AIDE = {
  ...
  planning: {
    ...
    points: [
      ...
      ['La fiche d’un salarié', "quatre onglets. Résumé : le cadre Pour la compta — une ligne par chose que la compta saisit : salaire de base (retenue ou maintenu, et pourquoi), heures sup à payer par taux, congés payés, arrêt de travail, acompte ; « aucun » quand il n’y a rien —, puis ce qui reste au salarié (récup, heures à rattraper) et le mois en heures, qui s’additionne (tout le mois, les jours à venir aux heures du planning), la case « demande à être payé » et où vont les heures sup. Jours : semaine par semaine, prévu et fait côte à côte, ce que chaque absence devient, les heures sup du jour et les alertes de la semaine. Compteur : le temps de récup du solde d’avant au solde d’après, les heures à rattraper, et l’année. Congés et acomptes : le solde de congés et les avances en euros. Le mois se change sans fermer la fiche, et le bouton Relevé édite le PDF."],
