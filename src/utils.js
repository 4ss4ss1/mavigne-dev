...
var MV_AIDE = {
  ...
  planning: {
    ...
    points: [
      ...
      ['Les heures sup et la récup', "les heures sup se comptent à la semaine, du lundi au dimanche : ce qui est fait au-delà du planning de la semaine, une fois les heures manquées de la semaine rattrapées — celles du salarié d’abord, puis celles du domaine. Les huit premières sont à 25 %, les suivantes à 50 %, et donnent 1 h 15 ou 1 h 30 de récup par heure. Une semaine appartient au mois où elle finit. Un congé payé, une récup, une formation sont des absences payées : ils ne se lisent jamais comme des heures manquées. Les absences passent avant un paiement : on ne paie que ce qui reste une fois les absences couvertes, si bien qu’un relevé porte une retenue sur salaire ou des heures sup à payer, jamais les deux."],
