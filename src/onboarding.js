...
function _mvLandingTile(fn, ico, titre, sub, or_) {
  ...
  return '<div onclick="' + fn + '" style="display:flex;align-items:center;gap:12px;background:' + bg
    ...
    + '<span style="flex:1">'
    + '<span style="display:block;font-size:var(--pt-base,14px);color:rgba(255,255,255,0.92)">' + titre + '</span>'
    + '<span style="display:block;font-size:var(--pt-micro,11px);color:rgba(255,255,255,0.42);margin-top:2px">' + sub + '</span>'
    + '</span>'
...
window.showPublicLanding = function () {
  ...
  pr.innerHTML =
    ...
    + 'border-radius:12px;padding:13px;font-size:var(--pt-base,14px);font-weight:700;cursor:pointer;font-family:Outfit,sans-serif">Ouvrir mon domaine</button>'
    ...
    + '</div>'
    + '<div style="text-align:center;margin-top:22px;font-size:var(--pt-micro,11px);color:rgba(255,255,255,0.3);line-height:1.7">'
