...
function _caveV2InjectCss(){
  ...
  +'.mva-fld label{display:block;font-size:10px;letter-spacing:.06em;color:var(--texte-doux,#8B8175);margin-bottom:4px;text-transform:uppercase}'
  ...
  +'.mva-useg button{flex:1;background:#fff;border:0;padding:9px 6px;font-family:inherit;font-size:12.5px;font-weight:500;color:var(--texte-doux,#8B8175);cursor:pointer}'
  ...
  +'.mva-derived div{font-size:11px;color:var(--texte-doux,#8B8175)}'
  ...
  +'.mvap-tot span{display:flex;flex-direction:column;align-items:center;font-size:10px;letter-spacing:1.2px;text-transform:uppercase;color:var(--texte-doux,#8B8175)}'
  ...
  +'.mvap-tot em{font-style:normal;font-size:11px;color:var(--texte-doux,#8B8175);font-variant-numeric:tabular-nums}'
  +'.mvap-note{font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:10px;line-height:1.5}'
  +'.mvfm-lg{display:flex;gap:14px;flex-wrap:wrap;font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:11px}'
  ...
  +'.mvfm-note{font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:10px;line-height:1.5}'
  ...
  +'.mvcv-note{font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:8px;line-height:1.5}'
  ...
  +'.mvmat-it em{font-style:normal;color:var(--texte-doux,#8B8175);font-variant-numeric:tabular-nums;margin-left:auto;text-align:right}'
  +'.mvmat-note{font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:8px}'
  ...
  +'.mvmat-ttl{font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:var(--texte-doux,#8B8175);font-weight:600;margin-bottom:10px}'
  ...
  +'.mva-meta{font-size:12px;color:var(--texte-doux,#8B8175);margin-top:2px}'
  ...
  +'.mva-row{display:flex;align-items:center;justify-content:space-between;font-size:12px;color:var(--texte-doux,#8B8175);padding:3px 0}'
  +'.mva-x{background:none;border:0;color:var(--texte-doux,#8B8175);cursor:pointer;font-size:15px;min-width:40px;min-height:40px}'
  +'.mva-hint{font-size:11.5px;color:var(--texte-doux,#8B8175);font-style:italic;margin:2px 0 10px}'
  /* — Chips millésime — */
  +'.mvcm-chips{display:flex;gap:7px;flex-wrap:wrap;align-items:center;margin:2px 0 12px}'
  +'.mvcm-lab{font-size:10px;letter-spacing:.1em;color:var(--texte-doux,#8B8175);text-transform:uppercase;margin-right:2px}'
  ...
  +'.mvb-meta{font-size:12px;color:var(--texte-doux,#8B8175);margin-top:2px}'
  ...
  +'.mvb-fld label{display:block;font-size:10px;letter-spacing:.06em;color:var(--texte-doux,#8B8175);margin-bottom:4px;text-transform:uppercase}'
  ...
  +'.mvb-no{background:#fff;border:1px solid rgba(138,90,56,.3);color:var(--texte-doux,#8B8175);font-weight:500;font-size:14px;padding:12px 16px;border-radius:11px;cursor:pointer;min-height:44px}'
  ...
  +'.mvb-tot small{font-size:11px;color:var(--texte-doux,#8B8175);display:block;letter-spacing:.08em;text-transform:uppercase;font-weight:400}'
  +'.mvb-hint{font-size:11.5px;color:var(--texte-doux,#8B8175);font-style:italic;margin:2px 0 10px}'
  +'.mvb-empty{text-align:center;color:var(--texte-doux,#8B8175);padding:34px 20px;font-size:13px}';
  document.head.appendChild(s);
}
...
function _mlInjectCss(){
  ...
  +'.mlx-hint{font-size:11.5px;color:var(--texte-doux,#8B8175);font-style:italic;margin:-4px 0 11px;line-height:1.5}'
  ...
  +'.mlx-wkd{margin-left:auto;font-size:11.5px;color:var(--texte-doux,#8B8175)}'
  ...
  +'.mlx-wke{font-size:12.5px;color:var(--texte-doux,#8B8175);padding:6px 0 2px}'
  ...
  +'.mlx-n{display:block;font-size:11.5px;margin-top:3px;color:var(--texte-doux,#8B8175)}'
  +'.mlx-ev.due .mlx-n{color:var(--rouge,#A0291E);font-weight:600}'
  +'.mlx-ev.warn .mlx-n{color:var(--orange,#B85A1A);font-weight:600}'
  +'.mlx-j{display:block;font-size:10.5px;color:var(--texte-doux,#8B8175);white-space:nowrap;margin-top:2px;text-align:right;flex-shrink:0;min-width:50px}'
  ...
  +'.mlx-foot{font-size:11.5px;color:var(--texte-doux,#8B8175);line-height:1.55;margin-top:10px;padding-top:10px;border-top:1px dashed rgba(138,90,56,.22)}'
  ...
  +'.mlx-rdv small{font-size:10.5px;font-family:inherit;font-weight:400;color:var(--texte-doux,#8B8175);margin-left:3px}'
  +'.mlx-rda{display:block;font-size:11px;color:var(--texte-doux,#8B8175);margin-top:2px}'
  ...
  +'.mlx-rdf{display:flex;justify-content:space-between;font-size:11px;color:var(--texte-doux,#8B8175);margin-top:5px}'
  ...
  +'.mlx-orgs{font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:2px}'
  ...
  +'.mlx-ar{color:var(--texte-doux,#8B8175);font-size:13px}'
  ...
  +'.mlx-empty{text-align:center;color:var(--texte-doux,#8B8175);padding:34px 20px;font-size:13px;line-height:1.6}';
  document.head.appendChild(s);
}
