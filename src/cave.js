...
function _caveV2InjectCss(){
  ...
  /* — Analyses maturité — */
  +'.mva-form{background:linear-gradient(180deg,var(--bg-card,#fff),var(--terre-pale,#F3EADF));border:1px solid rgba(201,168,76,.35);border-radius:14px;padding:14px;margin:2px 0 14px}'
  ...
  +'.mvb-fld input{width:150px;max-width:100%;font-family:inherit;font-size:var(--pt-base,14px);padding:9px 10px;border:1px solid rgba(138,90,56,.3);border-radius:9px;background:var(--bg-card,#fff);color:var(--texte,#2A241C)}'
