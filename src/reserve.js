...
function _rsvInjectCss(){
  ...
  st.textContent=''
    ...
    +'.mvr-mv-m{display:block;font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:1px}'
    ...
    +'.mvr-mv-more{font-size:11.5px;color:var(--texte-doux,#8B8175);font-style:italic;padding:9px 0 4px}'
    ...
    +'.mvr-seplot-m{display:block;font-size:11.5px;color:var(--texte-doux,#8B8175);margin-top:2px}'
    ...
    +'.mvr-sepstep-u{font-size:12px;color:var(--texte-doux,#8B8175);font-weight:400}'
...
// ═══════════════════════════ SECTION INTRANTS ═══════════════════════════
var _CATLBL={phyto:'Phyto',oeno:'Œno'};
var _CATCLS={phyto:'mvr-cat-p',oeno:'mvr-cat-o'};
...
function _rsvNpCatChange(){
  ...
  var src=document.getElementById('mvr-np-src'); if(src) src.value=(cat==='oeno')?'cave_so2':'registre';
  ...
  +'<div class="overlay" id="ovRsvAchat" onclick="closeOv(event,\'ovRsvAchat\')"><div class="modal" onclick="event.stopPropagation()">'
    ...
    +'<div class="modal-body">'
      ...
      +'<div id="mvr-np-block" style="display:none">'
        ...
        +'<div class="mvr-fl">Type d\'intrant</div><select class="mvr-fi" id="mvr-np-cat" onchange="_rsvNpCatChange()"><option value="phyto">Phyto \u2014 depuis le catalogue E-Phy</option><option value="oeno">Œno (SO\u2082, levures\u2026)</option></select>'
