...
function _rsvInjectCss(){
  ...
  st.textContent=''
    ...
    +'.mvr-fchip{flex:none;border:1.5px solid var(--line,#E7DECF);background:var(--bg-card,#FBFAF6);color:var(--muted,#7A7060);border-radius:999px;padding:7px 13px;font-size:var(--pt-txt,12.5px);font-weight:600;cursor:pointer;white-space:nowrap;display:flex;align-items:center;gap:6px;transition:background .12s,border-color .12s,color .12s}'
    +'.mvr-fchip .mvr-cnt{font-size:var(--pt-micro,11px);opacity:.7;font-weight:500}'
    ...
    +'.mvr-flink{border:none;background:transparent;color:var(--terre,#8A5A38);font-family:inherit;font-size:var(--pt-txt,12.5px);font-weight:600;cursor:pointer;padding:4px 2px;text-decoration:underline;text-underline-offset:2px;flex:none}'
    ...
    +'.mvr-sgico{width:34px;height:34px;border-radius:10px;background:var(--terre-pale,#F3EADF);border:1px solid #E6D8C4;display:flex;align-items:center;justify-content:center;font-size:var(--pt-sm,17px);flex:none}'
    +'.mvr-sgtx{flex:1;min-width:0}'
    +'.mvr-sgname{font-family:Cormorant Garamond,Georgia,serif;font-size:var(--pt-md,20px);font-weight:700;color:var(--texte,#2A241C);line-height:1.05;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    +'.mvr-sgline{font-size:var(--pt-micro,11px);color:var(--muted,#7A7060);margin-top:1px}'
    +'.mvr-sgbadge{flex:none;background:var(--cave,#14110D);color:#F0E2C8;border-radius:999px;padding:5px 11px;font-size:var(--pt-txt,12.5px);font-weight:600;display:flex;align-items:baseline;gap:4px}'
    ...
    +'.mvr-parc-l{font-size:var(--pt-txt,12.5px);color:#9C9184;margin-top:4px}'
    ...
    +'.mvr-parc-mv .lb{font-size:var(--pt-micro,11px);color:#8F8677}'
    +'.mvr-mv{display:flex;align-items:center;gap:10px;padding:10px 0}'
    +'.mvr-mv+.mvr-mv{border-top:1px solid rgba(138,90,56,.08)}'
    +'.mvr-mv-i{width:31px;height:31px;border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:var(--pt-base,14px);flex-shrink:0;background:var(--terre-pale,#F3EADF)}'
    ...
    +'.mvr-seplot-n{display:block;font-size:var(--pt-base,14px);font-weight:600;color:var(--texte,#2A241C)}'
    ...
    +'.mvr-sepstep>span{min-width:40px;text-align:center;font-size:var(--pt-sm,17px);font-weight:700;color:var(--terre,#8A5A38)}'
    ...
    +'.mvr-sepmot{flex:1;min-width:104px;background:var(--bg-card,#FBFAF6);border:1px solid rgba(138,90,56,.25);border-radius:11px;padding:11px 8px;font-family:inherit;font-size:var(--pt-txt,12.5px);color:var(--terre,#8A5A38);cursor:pointer;min-height:44px}'
...
function _rsvDoc(c){
  ...
  var css='h2{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1.1px;color:#8A5A38;'
    ...
    +'table{width:100%;border-collapse:collapse;font-size:var(--pt-nano,9.5px);margin-top:6px}'
...
function _rsvExportFutsPdf(){
  ...
  var css=''
    ...
    +'.hero .eye{font-size:var(--pt-lbl,10.5px);letter-spacing:.22em;text-transform:uppercase;color:#C2871E;font-weight:600}'
    ...
    +'.kpi .l{font-size:var(--pt-nano,9.5px);letter-spacing:.05em;text-transform:uppercase;color:#7A7060;margin-top:5px}'
    ...
    +'.grp-name{font-family:\'Cormorant Garamond\',Georgia,serif;font-size:var(--pt-sm,17px);font-weight:600;color:#14110D;flex:1}'
    +'.grp-meta{font-size:var(--pt-lbl,10.5px);color:#7A7060}'
    ...
    +'table.t th{background:#FBF6EE;text-align:left;padding:7px 14px;font-size:var(--pt-nano,9.5px);letter-spacing:.06em;text-transform:uppercase;color:#7A7060;font-weight:600;border-bottom:1px solid #E4DDD0}'
    ...
    +'.gt .lbl{font-size:var(--pt-md,20px);padding-left:8px}'
