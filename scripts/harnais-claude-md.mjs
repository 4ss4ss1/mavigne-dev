...
const SECTIONS = 138;  /* +§106 (PORTES). +§105 (FUT-LOC) ET RATTRAPAGE du cran qui trainait deja avant ce lot (le script le reclamait). +§104 (PIL-EXO/DIAG). +§103 (PIL-COH). +§102 (CAVE-6, non relevé dans son lot). +§101 (NAV-4/5). +§100 (NAV-3). +§99 (NAV-2). +§98 (NAV-1). +§97 (CAVE-5). +§96 (CAVE-3). +§95 (CAVE-2). +§94 (CAVE-1). +§93 (RDTMOY-2). +§92 (RDTMOY-1). +§91 (RDTAOC-1). +§90 (RDTMIL-1). +§89 (PILCRB-1). +§88 (CUVDOC-3). +§87 (CUVDOC-2). +§86 (CUVDOC-1) — et RATTRAPAGE des 4 crans que le script réclamait depuis §82. +§81 (PARC-1). +§80 (CUV-4). Relevé DANS LE LOT qui ajoute la section : le message
